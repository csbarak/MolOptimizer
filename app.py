...
# MCS
from MCS_Module import MCS_Script

# Chemical Descriptor Extraction

from Chemical_Descriptor_Extraction import Mordred_Features_Script
from Chemical_Descriptor_Extraction import RDKit_Features_Script

#import Decision_Tree_Algorithm.Expert_Mode.DecisionTreeRegressor_Improved_1

# Extreme Gradient Boosting Algorithm
from XGBoost_Algorithm.Expert_Mode import ExpertMode_One
from XGBoost_Algorithm.Expert_Mode import ExpertMode_Two
from XGBoost_Algorithm.Expert_Mode import ExpertMode_Prediction_Script
from XGBoost_Algorithm.Manual_Mode import Model_Training_Script
from XGBoost_Algorithm.Manual_Mode import Prediction_Script

# Decision Tree Regressor Algorithm
from Decision_Tree_Algorithm.Expert_Mode import Decision_Tree_Improved_1
from Decision_Tree_Algorithm.Expert_Mode import Decision_Tree_Improved_2
from Decision_Tree_Algorithm.Expert_Mode import Decision_Tree_Prediction_Script
from Decision_Tree_Algorithm.Manual_Mode import DecisionTreeRegressor_Manual
from Decision_Tree_Algorithm.Manual_Mode import DecisionTreeRegressor_Manual_Prediction

# Lasso Regression Algorithm
from Lasso_Regression_Algorithm.Expert_Mode import Lasso_Regression_N1
from Lasso_Regression_Algorithm.Expert_Mode import Lasso_Regression_N2
from Lasso_Regression_Algorithm.Expert_Mode import Lasso_Regression_Prediction_Script
from Lasso_Regression_Algorithm.Manual_Mode import Lasso_Regression_Manual
from Lasso_Regression_Algorithm.Manual_Mode import Lasso_Regression_Manual_Prediction


from flask import Flask, request


#set it to main directory containing sub-directories
...
def upload_files():
    ...
    MCS_Script.make_it_run(filename_ref,filename_ligdb)
    return render_template('main.html')
...
def DecisionTreeRegressor_Initial():
    ...
    if filename != '':
        ...
        # Pass the parameters to the boosting model
    DecisionTreeRegressor_Improved_1.make_it_rain(filename)
    return ('', 204)
#
#
#
...
def DecisionTreeRegressor_NotInitial():
    ...
    num_features = int(request.form.get('NumFeatures'))
    DecisionTreeRegressor_Improved_2.make_it_rain(filename, num_features)
    return ('', 204)
